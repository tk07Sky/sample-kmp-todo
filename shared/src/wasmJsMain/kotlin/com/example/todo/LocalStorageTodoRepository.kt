...
private fun Todo.toStored() = StoredTodo(id, title, notes, isDone, createdAtEpochMillis)

private fun StoredTodo.toDomain() = Todo(id, title, notes, isDone, createdAtEpochMillis)
